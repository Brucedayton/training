        ...
        <el-card class="user-list-card">
          ...
          <div class="recipient-toolbar">
            <div class="toolbar-row first-row">
              ...
              <el-button type="primary" @click="showAddUserDialog" style="margin-left: 10px">
                Add User
              </el-button>
            </div>
...
export default {
  ...
  setup() {
    ...
    const handleUsersAdded = (items) => {
      ...
      ElMessage.success(`Added ${items.length} items to recipients`)
    }
    // Helper functions
