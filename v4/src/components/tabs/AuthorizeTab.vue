        ...
        <el-card class="user-list-card">
          ...
          <el-tabs v-model="targetTab">
            <el-tab-pane label="Users" name="users">
              <el-input v-model="userSearchKeyword" placeholder="Search users" prefix-icon="Search" style="margin-bottom: 15px" />
              <div class="user-list">
                <div
            ...
            <el-tab-pane label="Groups" name="groups">
              <el-input v-model="groupSearchKeyword" placeholder="Search groups" prefix-icon="Search" style="margin-bottom: 15px" />
